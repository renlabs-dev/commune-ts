...
export function ProposalListHeader(
  ...
  return (
    <div className="flex-col items-center justify-between w-full gap-6 py-6 border-b border-gray-500 lg:flex lg:flex-row bg-black/50">
      <div className="flex items-center w-full max-w-screen-2xl px-4 mx-auto lg:px-4">
