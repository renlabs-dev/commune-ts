...
package](https://github.com/agicommies/subspace-network/pkgs/container/subspace) at the [**latest** tag](https://github.com/agicommies/subspace-network/pkgs/container/subspace/164109015?tag=latest). You can pull the
...
The provided [**docker-compose.yml** file](https://github.com/agicommies/communex/blob/main/docs/running_a_node/docker-compose.yml) expects the environment variable
...
[**./docker-compose.yml** file]: https://github.com/agicommies/communex/blob/main/docs/running_a_node/docker-compose.yml
