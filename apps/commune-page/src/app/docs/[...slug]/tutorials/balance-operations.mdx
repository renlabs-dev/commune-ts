...
```bash
comx balance stake <key-name> <amount> <validator-ss58address>
```

Similar to transferring if the validator key is already located on your disk you can use.

```bash
comx balance stake <key-name> <amount> <validator-name>
```
...
```bash
comx balance unstake <key-name> <amount> <validator-ss58address>
```
